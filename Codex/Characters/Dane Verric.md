...
> [!infobox|wikipedia]
> # Dane Verric
> [![[Codex/Assets/Characters/Dane_Verric_small.webp|cover hsmall]]](Codex/Assets/Characters/Dane_Verric.webp)
> ###### Basic Information
> Attribute |  Details |
> ---|---|
> Type | Character |
...
Introduced as the Fox Crew's scout when the party joined the caravan into the ice fields; identified as the expert at finding paths and avoiding the Frostway's monsters.
...
Volunteered to remain behind at camp to care for an injured companion, Kellan, while [[Lysa]] and [[Sela Ren|Sela]] continued guiding the party onwards.
