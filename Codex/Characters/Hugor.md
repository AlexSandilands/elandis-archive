...
Connections:
  ...
  - "[[Valtorran Empire]]"
Profession: Apothecary's Assistant
Importance: Minor
Status: Unknown
NoteIcon: npc
cssclasses:
...
> [!infobox|wikipedia]
> # Hugor
> [![[Codex/Assets/Characters/Hugor_small.webp|cover hsmall]]](Codex/Assets/Characters/Hugor.webp)
> ###### Basic Information
> Attribute |  Details |
> ---|---|
> Type | Character |
...
> Age | Teenage |
> Place | [[Lighthaven]] |
> Connections | [[Captain Lucius Draegor]]<br>[[Valtorran Empire]] |
> Profession | Apothecary's Assistant |
> ###### Status
> Attribute |  Details |
> ---|---|
...
**Hugor** is a teenage halfling from [[Lighthaven]], employed as an assistant at the Verdant Rose apothecary. Drawn in by the promise of prestige and a future in the Imperial ranks, he became an informant for [[Captain Lucius Draegor]] — a choice that brought him into the path of the [[The Bloody Nails|Bloody Nails]] and ultimately cost him everything he had been working toward.
...
Spotted at the Verdant Rose conversing with Captain Draegor; identified as an Imperial informant by the party. Kidnapped, dragged into the Darkwood, and interrogated under threat of death. Confessed to selling information in exchange for the promise of an Imperial posting. Coerced into delivering a fabricated report to Draegor as bait for an ambush, then released.

#### [[Session 30 - The Darkwood Ambush]]

Ryo, disguised as a courier, left a false letter for Hugor at the apothecary to maintain cover in the aftermath of the ambush.

#### [[Session 49 - The Silver Sage]]

Referenced in a recovered memory: Hugor had long since fled Lighthaven by the time the party returned to confront the blacksmith [[Dhorik]].
