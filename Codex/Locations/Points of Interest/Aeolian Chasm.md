...
Location: "[[Valtorra]]"
Defining Feature: A vast river-carved canyon spanned by the ruined Imperial viaduct of Skyreach
Importance: Major
Status: Active
NoteIcon: poi
cssclasses:
...
> Type | Point of Interest |
> Location | [[Valtorra]] |
> Defining Feature | River-carved canyon; ruins of the [[Skyreach]] viaduct |
> ###### Status
> Attribute |  Details |
> ---|---|
> Status | Active |

The **Aeolian Chasm** is a colossal, river-gouged canyon in the far south of [[Valtorra]], running some hundred miles from the southern mountains down to the ocean coast. For nearly a decade it was the site of [[Skyreach]] — a secret Imperial viaduct raised to vault the gorge — until the bridge was brought down, leaving its shattered remains strewn across and within the chasm. A natural barrier that the [[Valtorran Empire|Empire]] spent a fortune trying to overcome, the Aeolian remains one of the defining strategic features of the southern frontier.

## Location & Geography

The chasm sits in the far south of [[Valtorra]], roughly fifty miles west of [[Darmouth]]. It runs broadly north-to-south for about a hundred miles, descending from a small mountain range — the Aeolian Mountains — down to the southern ocean coast, where it opens onto wide coastal cliffs. Along its entire floor runs the Aeolian River, the water that carved the gorge over ages.

The river's parentage explains the shared name. The Luminor River rises in the central plains, where [[Val Luminor]] is built upon its banks, then forks in the south: the eastern branch runs through [[Val Miriel]] into the [[Gulf of Miriel]], while the southern branch becomes the Aeolian River as it cuts down through the mountains and the chasm to the sea. It is the same water under a regional name — which is why the chasm, the mountains, and the river all share the word "Aeolian."
...
Amid the burning camp, the party freed the prisoners and climbed the viaduct's four-hundred-foot pillars, planting charges at its weak points. As they fled to [[The Albatross]] with the wounded [[Barak Stormrider|Barak]], the fuses burned down and Skyreach collapsed in a thunderous cataclysm of rubble and dust — crippling the Empire's strategic infrastructure and leaving the chasm strewn with the ruins that mark it still.

## Trivia

- The Aeolian name belongs not just to the chasm but to the mountains it descends from and the river that carved it — all one continuous waterway, named for the region rather than for any of its three parts.
