...
- [x] Set Session Date
- [x] Update Calendar
- [x] Price for Chimera + Tigers
- [x] Chat with Governor
- [x] GG Tiefling
- [x] Encounters While Travelling City
	- [x] Northen Streets
	- [x] Southern Streets
	- [x] Bridge
	- [x] What happens if captured
- [x] Kai Temple Communion
- [x] Eryndor Ravens
- [x] Voice of the Empire
...
If the players go around town, they may here that [[Governor Tarlis Evandron|Tarlis]] is planning on doing a speech.
> [!info]- Action
> - Times are hard
...
| Option  |Result   |
|---|---|
|If less than full party|1 Hand, 1 Captain, 4 Guards|
|If full party|1 Hand, 1 Captain, 2 Veteran Guards, 2 Guards|

#### Valena's Bridge

- [[Valena's Bridge]] is heavily watched
- DC 30 Stealth

| Option              | Result                                                     |
| ------------------- | ---------------------------------------------------------- |
| Regardless of Party | 1 Hand, 1 Captain, 4 Veterans (on top of bridge), 8 guards |
...
- If fleeing through the streets:
- DC 13 checks
...
- There is 1 Guard Captain and several standard guards patrolling inside and out, ensuring that no uprising occurs from within [[The Hight Sept]]
- There are a few clerics wandering the halls
	- Tending to alters
	- Lighting candles
	- Praying occasionally

- [[Olldir]] is currently asleep
> [!question] Trigger
> If requested to wake [[Olldir]], DC 13 persuasion.
> > [!info]- Action
> >- If woken he will listen to what [[Kai]] has to say
> >- Before taking any action, will request to see [[Kai|Kai's]] stary form
> >- Very sceptical to allow any sort of action to happen due to the stars being more dark than they are light
> >- Suggests Kai needs to walk [[Selune's Path]], as clearly she has chosen him for something
