...
**Currently supported:** Characters, Items, Factions (including Local Chapters), Locations of subtype **Point of Interest** and **Region**, and Lore of subtype **Event**, **Cosmology / Concept**, and **Deity**. The Location reference also covers the City subtype's routing, but it isn't wired in yet — if the user wants a City, the reference explains how to redirect them. If the user asks for any other category, tell them it isn't supported yet and ask if they'd like a character, item, faction, location, or lore entry instead, or skip the skill.
