...
### Morning in Val Noren

* The party wakes to clear skies. [[Kai]] spends breakfast spreading tall tales about [[Dondar]]’s exploits ("The General Slayer") to the local soldiers.
* Dondar signs a fan’s mug with his own blood, while [[Ryo]] attempts to hustle the group in a card game; Dondar eventually wins a pot of gold from [[Eryndor]].
* Ryo attempts to source thieves' tools from Eryndor, as they are unavailable in the war-torn city.
* Dondar and Kai investigate the mysterious note found earlier. Through trial and error, they discover blood is the reagent required to activate the communication magic.
* Ryo uses Eryndor's blood to interact with the note. The other side asks for a report. Ryo replies, "Objective complete, awaiting orders."
* The response comes back: "Job must be completed before next steps." Ryo sends a final threatening message before the note is stowed away by Dondar.
...
* Marius provides Berberis with a letter of recommendation to take to [[Bjorn Aran]], the Governor of [[Val Aran]].
* Kai requests permission to train a religious force dedicated to [[Selûne]]. Marius, a devout follower of [[Torgar Earthshaker|Torgar]], is skeptical but allows Kai to meet with the local priest.
...
* [[Berberis]] interrogates the Imperial prisoners regarding the Red Priests. He learns the priests were a recent addition to the army and seemed to serve a different master than the standard Imperial command.
* Berberis organizes the release of disloyal soldiers, sending them into exile with a message for the Empire's leadership: "Clean your house."
* Refugees from [[Point Blackrock]] arrive in the city, having survived the crossing of the Frostway.
...
* Guided by the voice of Selune urging "Redemption," Kai stops fighting and casts *Cure Wounds* on the shadow. The entity dissolves into light, and Kai wakes up to find the black armour transformed into gleaming white and blue steel.
