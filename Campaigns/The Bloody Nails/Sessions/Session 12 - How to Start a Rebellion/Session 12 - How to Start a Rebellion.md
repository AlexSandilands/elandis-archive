...
> [!infobox|wikipedia]
> # Recording
> [![Title](https://img.youtube.com/vi/2v0-4GvzsYU/maxresdefault.jpg)](https://www.youtube.com/watch?v=2v0-4GvzsYU)
> # Basic Information
> Attribute |  Details |
> ---|---|
> Session # | 12 |
...
* **Tara's Peace:** [[Kai]] and [[Ryo]] visit [[Tara]] ([[Salla the Brave|Sela]]’s twin). They return the locket and Sela's bones. Tara is overwhelmed with emotion, finally finding closure, and considers leaving the village to travel.
* **Shopping:** At the local exchange, Kai purchases a chunk of Obsidian and silver dust for spell components.
* **Recovery:** The party takes a short rest at the Redleaf Inn to recover before heading back to the city.

### Return to Camaar

* **High Alert:** The guards at the gates of [[Camaar]] are conducting searches, but the party passes through (with [[Ryo]] disguised as a human).
* **The Alchemist's Reward:** [[Teresa]] is reunited with [[Thane]]. Overjoyed, Thane rewards the party with:
    * 1x Potion of Hill Giant Strength (Given to [[Vaeleran]]).
    * 1x Book of Basic Alchemy (Given to [[Kai]]).
    * 4x Potion of Healing (Discounted purchase).
    * 1x Potion of Invisibility (Available for purchase later).
* **Dondar's Study:** [[Dondar]] spends the evening scribing *Misty Step* into his spellbook.
...
* **The War Room:** [[Barak Stormrider]] welcomes them and leads them to a hidden basement war room. They meet [[Gromdal]], a dwarven engineer.
* **The Objective:** Destroy the imperial bridge, [[Skyreach]], before it is completed (within a few weeks/before winter).
* **The Target:** The bridge is hundreds of feet tall. [[Gromdal]] identifies three structural weak points:
    1.  **West Pillar:** Hollow with internal stairs.
